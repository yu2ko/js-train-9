...
function findElementGreaterThan(arr, num) {
  ...
  if (!Array.isArray(arr)) {
    ...
    const result = arr.find((item) => item > num);
...
function findIndexByProperty(arr, name) {
  ...
  if (!Array.isArray(arr)) {
    ...
    return arr.findIndex((item, arr) => item.name === name);
  }
}
...
function findLastEvenNumber(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    const result = arr.findLast((item) => item % 2 === 0);
    if (typeof result !== undefined) {
      return result;
    } else {
      console.log("Парних чисел не знайдено");
    }
  }
}
...
function getPositiveArrayValues(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let iter = arr.values();
    return Array.from(iter).filter((value) => value > 0);
  }
}
...
function removeAndDouble(arr, startIdx) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let delItem = arr.splice(startIdx);
...
function sumAndPrint(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let sum = arr.reduce((accum, curValue) => accum + curValue);
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  if (!Array.isArray(arr)) {
    ...
    const squareArray = flatArray.map((item) => item * item);
    return squareArray.filter((item) => item > threshold);
  }
}
...
function getLastElementsSumAndPrint(arr, n) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let lastItems = arr.slice(-n);
    let sum = lastItems.reduceRight((accum, curValue) => accum + curValue);
    lastItems.forEach((item) => console.log(item));
    return sum;
  }
}
...
function findLongestWord(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let longWord = arr.reduce((accum, curValue) => {
...
function findDuplicateElements(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    const doubleItems = arr.filter((item, index) => {
...
function calculateTotalPrice(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    const amount = arr.reduce((accum, curValue) => {
